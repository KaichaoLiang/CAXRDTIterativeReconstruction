...
parameter.lambdaSpa = 6e-3;
parameter.betaTVSpaVlambdaSpa=1e-2;
parameter.betaTVSpa = parameter.betaTVSpaVlambdaSpa*parameter.lambdaSpa;
parameter.totalSPStep = 8000;
parameter.savePath = 'ResultsOSEMTVSimple_15View_ITV6e-3';
ReconImage = OSEMITV3DXRDTCalculateLossGS(PanelData, sysParameter, TransSys, GeoSys, DiffSys, ResponseMatrix,parameter);
