...
parameter.totalSPStep = 12000;
parameter.savePath = 'ResultsOSEMTV_15ViewTV6e-3';
ReconImage = OSEMTV3DXRDTCalculatas[eLossGS(PanelData, sysParameter, TransSys, GeoSys, DiffSys, ResponseMatrix,parameter);
