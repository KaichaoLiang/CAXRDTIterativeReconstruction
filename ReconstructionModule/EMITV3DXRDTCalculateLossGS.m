...
function estimation = EMITV3DXRDTCalculateLossGS(rawData, sysParameter, TransSys, GeoSys, DiffSys, ResponseMatrix,parameter)
%------------------------------Parameter-----------------------------------
