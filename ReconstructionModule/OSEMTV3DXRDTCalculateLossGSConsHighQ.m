...
function estimation = OSEMTV3DXRDTCalculateLossGSConsHighQ(rawData, sysParameter, TransSys, GeoSys, DiffSys, ResponseMatrix,parameter)
%------------------------------Parameter-----------------------------------
...
for totalstep = 1:totalSPStep
    ...
    estimation(181:end,:,:)=repmat(estimation(180,:,:),20,1,1);
